...
rule += " div.cwPropertiesTableContainer[id*='pct70'] { width: calc(70% - 1.5rem); }";
...
rule += " div.cwPropertiesTableContainer[id*='pct25'] { width: calc(25% - 1.5rem); }";

rule += " div.property-box[class*='pct75']{width: calc(75% - 1.5rem);}";
rule += " div.property-box[class*='pct70']{width: calc(70% - 1.5rem);}";
